# Guide on modifying the blog website

Original source is from [template's OG repository](https://github.com/chrismwilliams/astro-theme-cactus). Most, if not all of the material below is straight from there! Big shout out to [Chris Williams](https://github.com/chrismwilliams) for this clean template :)
